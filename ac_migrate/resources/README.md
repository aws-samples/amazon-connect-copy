# Amazon-Connect Resource Migration Guide

Please refer to INSTRUCTIONS for implementation details

The Amazon-Connect migration script copies resource components from the source Amazon Connect instance
...
- Copy `ac_migrate/bin` and `ac_migrate/resources` folders to your environment
